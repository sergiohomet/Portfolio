...
const icons = {
  ...
  html5: createSvgIcon(`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4"><path d="M2 21.875L3.875 2H22.125L20.25 21.875L12 24.5L2 21.875Z" fill="#E44D26"/><path d="M12 4.125V22.5125L18.5 20.6L20.25 4.125H12Z" fill="#F16529"/><path d'use strict';
d="M7.75 8.375H12V10.5H9.5L9.75 12.625H12V14.75H7.5L7 8.375Z" fill="#EBEBEB"/><path d="M7.875 17H10L10.125 18.375L12 19L13.875 18.375L14.125 15.875H7.75L8 19.375L12 20.75L16 19.375L16.5 13.75H12V15.875H14.25L14 17.5L12 18.125L10 17.5L9.875 16H7.875V17Z" fill="white"/><path d="M12 8.375V10.5H16.25L15.75 14.75H12V12.625H14.5L14.75 10.5H12V8.375H16.75L17 6.25H12V8.375Z" fill="white"/></svg>`),
  css3: createSvgIcon(`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4"><path d="M2 21.875L3.875 2H22.125L20.25 21.875L12 24.5L2 21.875Z" fill="#1572B6"/><path d="M12 4.125V22.5L18.5 20.6L20.25 4.125H12Z" fill="#33A9DC"/><path d'use strict';
d="M7.625 8.375H12V10.5H9.875L10.125 12.625H12V14.75H7.5L7.125 8.375Z" fill="white"/><path d="M12 8.375H16.375L16.125 10.5H12V8.375ZM12 12.625H14.25L14 14.75L12 15.375V12.625Z" fill="#EBEBEB"/><path d="M7.875 17H10L10.125 18.375L12 19L13.875 18.375L14.125 15.875H10.125L10 17H7.875Z" fill="white"/></svg>`),
